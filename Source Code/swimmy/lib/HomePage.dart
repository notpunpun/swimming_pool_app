...
class _HomePageState extends State<HomePage> {
  ...
  DateTime selectedDate = DateTime.now(); // date picker
  int _currentIndex = 0;
...
//animate transition
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: NetworkImage(
                'https://i.pinimg.com/564x/c0/b6/86/c0b68650d27db0ab677af1012825a464.jpg'),
            fit: BoxFit.cover,
          ),
        ),
        child: Center(
  ...
  List<String> imagePaths = [
    'https://i.pinimg.com/564x/f1/9e/9d/f19e9dd46675dd33a7b9bf611732ef8d.jpg',
    'https://hepa.umt.edu.my/wp-content/uploads/2021/03/Kolam-Terjun-2.jpg',
    'https://fastly.4sqi.net/img/general/600x600/94525410_VeILFMyAv1sP1YjUFEAVmmSoXV0raOb5Wzrylo4qtSs.jpg',
  ];
  ...
  @override
  void dispose() {
    _timer.cancel(); //stop from running
    super.dispose(); //cleanup operation
  }
}
